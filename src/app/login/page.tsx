      ...
      <div className="h-screen md:flex">
        <div className="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center hidden">
          <div>
            ...
            <p className="text-white mt-1">
                 Gerencie suas senhas com facilidade e tranquilidade.    
            </p>
            <button
              type="submit"
        ...
        <div className="flex md:w-1/2 justify-center py-10 items-center bg-background">
          <form className="bg-background shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <p className="text-sm font-normal text-gray-300 mb-7">
              Bem vindo!
            </p>
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-7 gap-2">
              <svg
            ...
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-8 gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 text-gray-400"
                viewBox="0 0 20 20"
